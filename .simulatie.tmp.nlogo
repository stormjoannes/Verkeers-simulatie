...
to go
  ...
  ask cars[
    ;; is er een auto 1 patches voor je
    let car-infront one-of cars-on patch-ahead 1
...
"" ""
PENS
"default" 1.0 0 -2674135 true "" "plot mean [speed] of cars with [ number = 1 ]"
"pen-1" 1.0 0 -13345367 true "" "plot mean [speed] of cars with [ number = 2 ]"
